...
def install_sendmail():
	...
	os.system("sudo apt-get install sendmail -y")
	# change config file
	os.system("sudo cp /home/pi/Pi_Setup/php.ini /etc/php5/apache2/php.ini")
	print("\nUPDATE: SENDMAIL INSTALLED\n")
...
def to_access_point():
	...
	os.system("/home/pi/Pi_Setup/AP_Setup/toRouter.sh")
