...
ip=$(ifconfig wlan0 | grep "inet addr" | sed -r -e "s/inet addr:([^ ]*) .*/\1/")
echo "" >> /home/pi/Pi_Setup/cloudprint_Setup/success_code.txt
echo "Address to enter in your browser to manager printers:" >> /home/pi/Pi_Setup/cloudprint_Setup/success_code.txt
echo $ip:631 >> /home/pi/Pi_Setup/cloudprint_Setup/success_code.txt
